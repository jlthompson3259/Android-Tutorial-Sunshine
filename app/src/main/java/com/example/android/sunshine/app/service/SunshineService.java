...
public class SunshineService extends IntentService {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if(cursor.moveToFirst())
            returnID =  cursor.getInt(cursor.getColumnIndex(WeatherContract.LocationEntry._ID));
        else {
            ...
            Uri addedUri = getApplicationContext().getContentResolver().insert(
                    WeatherContract.LocationEntry.CONTENT_URI, values);
            returnID = ContentUris.parseId(addedUri);
        }
        return returnID;
    }
